...
const Message = () => {
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <View style={{ width: 332, height: 521, borderWidth: 1, borderColor: '#7A94B7', borderLeftWidth: 4, borderBottomWidth: 4, borderRadius: 8, }}>
                ...
                <View style={{ margin: 15, width: 290, height: 414 }}>
                    ...
                    <Text style={{ fontSize: 13, color: '#494B4A', marginTop: 20 }}>Aman Singh</Text>
